package com.jasper.algs.leetcode.array.qu0027;
...
class SolutionTest {
	...
	void testRemoveElement1(int[] nums, int val, int expected) {//拷贝覆盖
		int actual = new com.jasper.algs.leetcode.array.qu0027.solu1.Solution().removeElement(nums, val);
	...
	void testRemoveElement2(int[] nums, int val, int expected) {//交换移除
		int actual = new com.jasper.algs.leetcode.array.qu0027.solu2.Solution().removeElement(nums, val);
		assertThat(actual).isEqualTo(expected);
	}
