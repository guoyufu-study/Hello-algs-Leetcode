package com.jasper.algs.leetcode.qu0283;
...
class SolutionTest {
	...
	void testMoveZeroes1(int[] nums, int[] expected) {
		new com.jasper.algs.leetcode.qu0283.solu1.Solution().moveZeroes(nums);
	...
	void testMoveZeroes2(int[] nums, int[] expected) {
		new com.jasper.algs.leetcode.qu0283.solu2.Solution().moveZeroes(nums);
