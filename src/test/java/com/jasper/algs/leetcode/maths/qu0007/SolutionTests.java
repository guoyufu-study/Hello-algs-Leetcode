package com.jasper.algs.leetcode.maths.qu0007;
...
public class SolutionTests {
	...
	public void testReverseInteger1(int x, int expected) {// 溢出检查+弹出推入
		int rev = new com.jasper.algs.leetcode.maths.qu0007.solu1.Solution()
				.reverse(x);
	...
	public void testReverseInteger2(int x, int expected) {// 优化溢出检查+弹出推入
		int rev = new com.jasper.algs.leetcode.maths.qu0007.solu2.Solution()
				.reverse(x);
		assertThat(rev).isEqualTo(expected);
	}
	...
	public void testReverseInteger3(int x, int expected) {//负数转正数=》优化溢出检查+弹出推入
		int rev = new com.jasper.algs.leetcode.maths.qu0007.solu3.Solution()
				.reverse(x);
		assertThat(rev).isEqualTo(expected);
	}
