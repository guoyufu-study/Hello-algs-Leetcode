package com.jasper.algs.interview.q1610;
...
class SolutionTest {
	...
	void testMaxAliveYear1(int[] birth, int[] death, int expected) {//暴力求解
		assertThat(new com.jasper.algs.interview.q1610.solu1.Solution().maxAliveYear(birth, death))
		.isEqualTo(expected);
	}
	...
	void testMaxAliveYear2(int[] birth, int[] death, int expected) {//暴力求解
		assertThat(new com.jasper.algs.interview.q1610.solu2.Solution().maxAliveYear(birth, death))
			.isEqualTo(expected);
	}
	...
	void testMaxAliveYear3(int[] birth, int[] death, int expected) {
		assertThat(new com.jasper.algs.interview.q1610.solu3.Solution().maxAliveYear(birth, death))
		.isEqualTo(expected);
	}
